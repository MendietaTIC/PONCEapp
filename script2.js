    ...
    const pictograms = {
      ...
      Números: [
        ...
        Sentimientos: [
            ...
            { src: 'https://imgur.com/KEqyPuj.png', text: 'Celos',gif: 'https://imgur.com/xcuk66z.gif'},
            ...
            { src: 'https://imgur.com/Aa010Tm.png', text: 'Estresado',gif: 'https://imgur.com/xcuk66z.gif'},
            { src: 'https://imgur.com/R44RLh1.png', text: 'Frustrado' },
            { src: 'https://imgur.com/LXb8w8b.png', text: 'Miedo' },
            { src: 'https://imgur.com/v2RM0ju.png', text: 'Orgulloso',gif: 'https://imgur.com/xcuk66z.gif'},
        ...
        Deporte: [
            ...
            { src: 'https://imgur.com/2c1HMYo.png', text: 'Baseball' ,gif: 'https://imgur.com/xcuk66z.gif'},
            { src: 'https://imgur.com/PHNpjIC.png', text: 'Bicicleta',gif: 'https://imgur.com/xcuk66z.gif'},
            { src: 'https://imgur.com/XSK2hcT.png', text: 'Boxeo' },  
            { src: 'https://imgur.com/qlfaoyY.png', text: 'Caminar',gif: 'https://imgur.com/xcuk66z.gif'},
